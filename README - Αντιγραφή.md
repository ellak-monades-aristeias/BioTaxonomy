...
Μπορεί να χρησιμοποιηθεί από φοιτητές βιολογίας, καθηγητές δευτεροβάθμιας και τριτοβάθμιας εκπαίδευσης, μαθητές, γεωπόνους, κτηνιάτρους ή γενικά όποιον ενδιαφέρεται να μάθει για τη βιολογία ή να συνεισφέρει στη Wikipedia κάνοντας προσθήκες και διορθώσεις. 
